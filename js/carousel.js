...
document.addEventListener("DOMContentLoaded", function() {
	new Carousel(document.querySelector('#Project'), {
		slidesToScroll: 1,
		slidesVisible: 1,
		pagination: true
	...
	new Carousel(document.querySelector('#Project1'), {
		slidesToScroll: 1,
		slidesVisible: 1,
		pagination: true
	...
	new Carousel(document.querySelector('#Project2'), {
		slidesToScroll: 1,
		slidesVisible: 1,
		pagination: true
	...
	new Carousel(document.querySelector('#Project3'), {
		slidesToScroll: 1,
		slidesVisible: 1,
		pagination: true
